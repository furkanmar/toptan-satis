...
namespace WholesaleApi.Migrations
{
    ...
    [Migration("20260502155843_AddMaxOrderAmount")]
    partial class AddMaxOrderAmount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("delivery_note_seq");
            ...
            modelBuilder.Entity("WholesaleApi.Entities.CreditTransaction", b =>
                {
                    ...
                    b.HasIndex("StoreId", "WholesalerId", "IsFullyAllocated", "CreatedAt")
            ...
            modelBuilder.Entity("WholesaleApi.Entities.PaymentAllocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WholesaleApi.Entities.PaymentAllocation", b =>
                {
                    b.HasOne("WholesaleApi.Entities.CreditTransaction", "DebitTransaction")
                        .WithMany("DebitAllocations")
                        .HasForeignKey("DebitTransactionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WholesaleApi.Entities.CreditTransaction", "PaymentTransaction")
